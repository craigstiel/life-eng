    ...
    <v-row>
        ...
        <v-col cols="12" md="10" sm="10">
            ...
            <v-form ref="form" v-model="valid" lazy-validation>
                <v-col cols="12" md="12">
                    <v-text-field v-model="email" :rules="emailRules" label="E-mail" class="less-spaces" required></v-text-field>
                </v-col>
                <v-col cols="12" md="12">
                    <v-text-field v-model="password" :append-icon="show1 ? 'visibility' : 'visibility_off'"
                                    ...
                                    label="Пароль" class="less-spaces"
                                    counter @click:append="show1 = !show1"></v-text-field>
                </v-col>
                <v-col cols="12" md="12">
                    <v-btn :disabled="!valid" color="success" block depressed @click="login">
                        Войти
                    </v-btn>
                    <a @click="$router.push({name: 'restore_password'})"><p class="font-weight-black">
                        Забыли пароль?
                    </p></a>
                </v-col>
            </v-form>
